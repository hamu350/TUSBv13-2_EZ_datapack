...
# 追加： アイランドチェック
execute if data storage skill: Skill{Name:"アイランドチェック",Level:1} run data modify storage skill: Skill set from storage skill: Data.Common[{Name:"アイランドチェック",Level:1}]
