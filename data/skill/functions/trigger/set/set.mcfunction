...
execute if data storage item: Item.tag.UniqueName run data modify storage item: Item.tag.SkillLore append from block 2 3 2 Text1
#説明
data modify storage item: Item.tag.SkillLore append from storage skill: Skill.Lore[]
#発動条件
...
data modify storage item: Item.tag.SkillLore append from block 2 3 2 Text1
#消費MP
...
execute if data storage skill: Skill.Damage run data modify storage item: Item.tag.SkillLore append from block 2 3 2 Text1
# 追加： Loreセット
data modify storage item: Item.tag.display.Lore append from storage item: Item.tag.SkillLore[]
