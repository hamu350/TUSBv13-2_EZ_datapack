...
#Level2のときは4秒 + 100で区別
# 範囲増加 [10→15]
execute if entity @s[scores={Kaishaku=0..9000}] run scoreboard players set @e[tag=Enemy,distance=..15] Kaishaku 4
execute if entity @s[scores={Kaishaku=10000..}] run scoreboard players set @e[tag=Enemy,distance=..15] Kaishaku 104
