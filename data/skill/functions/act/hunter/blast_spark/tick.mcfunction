...
###弾召喚
# 追加： 飛距離増加
summon minecraft:arrow ^ ^ ^ {Tags:[Skill,BlastSpark,CooldownRequired,NativeTask,FlyingRequired],PortalCooldown:15,NoGravity:true,Silent:true,PierceLevel:127b,ShotFromCrossbow:true,Potion:"minecraft:luck"}
