#> skill:act/common/islandcheck/data/skylands.417
#
# 
#
...
tellraw @s [{"text":"スティーブ島"},{"text": "   難易度:"},{"text":"簡単","color": "green"}]
tellraw @s [{"text":"[スティーブ...頭の中に爆弾が！]"}]
tellraw @s [{"text":"[スポナーが嫌な隠され方をしているので、ダウジングは持って行った方がいいかも。]"}]