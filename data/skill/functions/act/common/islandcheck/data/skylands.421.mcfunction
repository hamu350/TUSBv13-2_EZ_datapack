#> skill:act/common/islandcheck/data/skylands.421
#
# 
#
...
tellraw @s [{"text":"かぼちゃ島"},{"text": "   難易度:"},{"text":"簡単","color": "green"}]
tellraw @s [{"text":"[ハッピーハロウィン！]"}]
tellraw @s [{"text":"[おかしをくれてもいたずらしちゃうぞ！]"}]
