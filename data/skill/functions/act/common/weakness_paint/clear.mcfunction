...
execute if score @s Weakness matches 9900..10000 store result storage tusb_mob: "遅延ステータス"."ステータス"."物理攻撃力" int 1 run data get storage tusb_mob: "遅延ステータス"."ステータス"."物理攻撃力" 4
...
execute if score @s Weakness matches 9900..10000 store result storage tusb_mob: "遅延ステータス"."ステータス"."魔法攻撃力" int 1 run data get storage tusb_mob: "遅延ステータス"."ステータス"."魔法攻撃力" 4
