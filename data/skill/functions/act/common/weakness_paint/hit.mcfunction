...
execute if entity @e[tag=WeakPaint,limit=1,sort=nearest,scores={Weakness=3}] store result storage tusb_mob: "遅延ステータス"."ステータス"."物理攻撃力" int 0.01 run data get storage tusb_mob: "遅延ステータス"."ステータス"."物理攻撃力" 25
...
execute if entity @e[tag=WeakPaint,limit=1,sort=nearest,scores={Weakness=3}] store result storage tusb_mob: "遅延ステータス"."ステータス"."魔法攻撃力" int 0.01 run data get storage tusb_mob: "遅延ステータス"."ステータス"."魔法攻撃力" 25
...
execute if entity @e[tag=WeakPaint,limit=1,sort=nearest,scores={Weakness=3}] run scoreboard players set @s Weakness 10005
