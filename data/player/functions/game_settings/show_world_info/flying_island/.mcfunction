...
tellraw @s ""
tellraw @s [{"translate":"TUSB神社","color":"red","clickEvent": {"action": "run_command","value": "/trigger ChangeSettings set 546"}},{"translate":" : ","color": "white"} ,{"storage":"area:","nbt":"capture.flying_island{046:0}.046","font":"ender_eye","color":"gray"},{"storage":"area:","nbt":"capture.flying_island{046:1}.046","font":"ender_eye","color":"#ffffff"}]
tellraw @s [{"translate":"飛空島道場","color":"green","clickEvent": {"action": "run_command","value": "/trigger ChangeSettings set 547"}},{"translate":" : ","color": "white"},{"storage":"area:","nbt":"capture.flying_island{047:0}.047","font":"ender_eye","color":"gray"},{"storage":"area:","nbt":"capture.flying_island{047:1}.047","font":"ender_eye"}]
