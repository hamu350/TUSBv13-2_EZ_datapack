...
### 遅延ステータス
# 属性値
# 追加： 属性値変更 変更前[100 100 -50 -50 100]
...
data modify storage tusb_mob: "遅延ステータス"."ステータス".AnalyseLog set value '[{"translate":"%1$sいらっしゃい。当店自慢のひえひえの氷はいかが？","with":[{"translate":"【能力：格闘・移動・射的・範囲攻撃・追撃】","color":"#00FF00"}]}]'
# AI
