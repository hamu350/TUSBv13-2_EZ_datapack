...
# 追加： ルートテーブルをお楽しみt3exに
data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Loot:"item:item/carrot_on_a_stick/weapon/super_debaria",Count:1,Chance:0.3d},{Loot:"item:item/carrot_on_a_stick/enjoy_memory_star_rank3_ex",Count:1,Chance:1.0d},{Loot:"item:item/carrot_on_a_stick/secret_exp_bug_memory_star",Count:1,Chance:1.0d},{Loot:"item:item/carrot_on_a_stick/secret_exp_bug_memory_star",Count:1,Chance:0.75d},{Loot:"item:item/carrot_on_a_stick/secret_exp_bug_memory_star",Count:1,Chance:0.5d}]
...
# 追加： lv44時にルートテーブルをお楽しみt3に
execute if data storage tusb_mob: _{Level:44} run data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Loot:"item:item/carrot_on_a_stick/enjoy_memory_star_rank2",Count:1,Chance:1.0d},{Loot:"item:item/carrot_on_a_stick/secret_exp_bug_memory_star",Count:1,Chance:1.0d}]
