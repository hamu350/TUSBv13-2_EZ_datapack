...
# 追加： lv111[罠産]時にルートテーブルをお楽しみt3に
execute if data storage tusb_mob: _{Level:111} run data modify storage tusb_mob: "遅延ステータス"."ステータス".LootTable set value [{Loot:"item:item/carrot_on_a_stick/enjoy_memory_star_rank3",Count:1,Chance:1d}]
