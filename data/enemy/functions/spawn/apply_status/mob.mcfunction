...
### 追加： 属性値がマイナスだったら0にする
execute if score @s ElementFire matches -2147483648..-1 run scoreboard players set @s ElementFire 0
execute if score @s ElementIce matches -2147483648..-1 run scoreboard players set @s ElementIce 0
execute if score @s ElementLightning matches -2147483648..-1 run scoreboard players set @s ElementLightning 0
execute if score @s ElementLight matches -2147483648..-1 run scoreboard players set @s ElementLight 0
execute if score @s ElementDark matches -2147483648..-1 run scoreboard players set @s ElementDark 0
