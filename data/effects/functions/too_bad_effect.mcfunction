...
# 追加： super_doomをデバリア無効10カウントに変更
execute if entity @s[advancements={effects:invisible={super_doom=true}}] unless score @s DoomCount matches 1..31 run function effects:doom/apply
